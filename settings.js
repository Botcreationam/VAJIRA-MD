...
global.owner = [process.env.OWNER_NUMBER] || ['260978277538'] // Owner number , (අයිතිකරුගේ නම්බර් එක )
...
OWNER_NUMBER: process.env.OWNER_NUMBER || '260978277538'  ,    
ALIVE: process.env.ALIVE || `default`,
OWNER_NAME: process.env.OWNER_NAME || 'franklin' ,     
AUTO_STATUS_READ:  process.env.AUTO_STATUS_READ  || true   ,    
AUTO_VOICE:  process.env.AUTO_VOICE  || true   ,
AUTO_STICKER: process.env.AUTO_STICKER || true   ,
WELCOME:  process.env.WELCOME  || false ,    
NUMBER_212_BLOCK: process.env.NUMBER_212_BLOCK || true   ,
FOOTER: process.env.FOOTER ||  '© Franklins - ＭＤ - Ｖ4',
